...
public class JavaMailUtils {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        int res=sendEmail("smtp.ldygo.com", "chenzl002@ldygo.com", "iNUJe0MORTXRjt7j", "chenzl002@ldygo.com", new String[]{  
                "834039869@qq.com","chenzeliang90@163.com" //这里就是一系列的收件人的邮箱了  
